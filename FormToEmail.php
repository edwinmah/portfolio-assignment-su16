...
<head>
  ...
  <meta name="description" content="enter a brief site description">
...
<body>
  ...
  <main id="content">
    <div class="container">
      <div class="thank-you">
        <p class="success">Thank you, <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?>. Your message has been sent.</p>
